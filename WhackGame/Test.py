...
boltAnim = pyganim.PygAnimation([('Resource/bolt_strike_0001.png', 0.1),
                                 ('Resource/bolt_strike_0002.png', 0.5),
...
dara = boltAnim.getCopy()

a = 0

def getanim():
    return pyganim.PygAnimation([('Resource/bolt_strike_0001.png', 0.1),
...
myanimation = ANIM.getPsyduckanim()
